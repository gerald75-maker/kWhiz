...
const messages = {
  fr: {
    ...
    'backup.restoredOne': '{count} réglage restauré. Rechargement…',
    'backup.restoredMany': '{count} réglages restaurés. Rechargement…',
  ...
  en: {
    ...
    'backup.restoredOne': '{count} setting restored. Reloading…',
    'backup.restoredMany': '{count} settings restored. Reloading…',
