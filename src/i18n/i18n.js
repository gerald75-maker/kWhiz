...
const phrases = {
  ...
  'Résultat copié dans le presse-papiers.': 'Result copied to the clipboard.', 'Résultat partagé.': 'Result shared.', 'Partage impossible sur cet appareil.': 'Sharing is unavailable on this device.',
  ...
  'Source officielle': 'Official source', 'Vérifié le': 'Checked on', 'Coût le plus bas': 'Lowest cost', 'coût le plus bas': 'lowest cost',
  'Pourquoi ce choix ?': 'Why this recommendation?', 'Kilométrage analysé': 'Mileage analysed', 'Recharge rapide': 'Fast charging', 'Seuil de rentabilité': 'Break-even point',
...
export const TRANSLATED_TARIFF_TEXT = Object.freeze({
  'Tarif unique': 'Standard price', 'Sans abonnement': 'No subscription', 'Abonnement mensuel': 'Monthly subscription', 'Abonnement annuel': 'Annual subscription',
  ...
  'Happy Hours - heures creuses': 'Happy Hours — off-peak', 'Tarif standard': 'Standard price', 'Sans forfait': 'No plan',
  'Atlante Go - mensuel': 'Atlante Go — monthly', 'Application Fastned - remise 10 %': 'Fastned app — 10% discount',
