...
const messages = {
  fr: {
    ...
    'comparison.heading.intro': 'Comparez les coûts, les abonnements et leur rentabilité pour comprendre le classement selon votre profil.',
    ...
    'comparison.summary': 'Calcul pour {km} km/mois, dont {fast} % sur des bornes rapides, avec une consommation de {consumption} kWh/100 km. Le coût de recharge à domicile, identique pour toutes les formules, n’influence pas ce classement.',
    'comparison.thresholdExplanation': 'Le seuil indique à partir de quel kilométrage l’abonnement devient avantageux par rapport à l’offre sans abonnement du même réseau, selon votre profil. Il ne signifie pas nécessairement que cette formule est la moins chère de kWhiz.',
    ...
    'profile.ranking.estimatedMonthlyCost': 'Coût mensuel estimé', 'profile.ranking.next': 'Voir la suite du classement', 'profile.ranking.hideNext': 'Masquer la suite du classement',
    'profile.ranking.lowestCost': 'Meilleur coût', 'profile.ranking.costUnavailable': 'Coût indisponible',
    'profile.ranking.details': 'Détails', 'profile.ranking.viewDetails': 'Voir le détail de {operator} · {formula}',
    ...
    'map.station.atlanteAvailability': 'Voir les disponibilités chez Atlante',
    ...
    'backup.downloaded': 'Profil et préférences sauvegardés.',
    ...
    'backup.restoredOne': 'Profil et préférences restaurés.',
    'backup.restoredMany': 'Profil et préférences restaurés.',
    ...
    'refresh.buttonLabel': 'Actualiser kWhiz',
    ...
    'operators.map': 'Carte',
    'operators.details': 'Détails',
    'operators.detailsFor': 'Voir les détails de {formula}',
  ...
  en: {
    ...
    'comparison.heading.intro': 'Compare costs, subscriptions and break-even points to understand the ranking for your profile.',
    ...
    'comparison.summary': 'Calculation for {km} km/month, including {fast}% at fast chargers, with an efficiency of {consumption} kWh/100 km. Home charging costs the same for every plan and does not affect this ranking.',
    'comparison.thresholdExplanation': 'The threshold shows the monthly mileage from which the subscription becomes cheaper than the same network’s no-subscription plan, based on your profile. It does not necessarily mean that this plan is the cheapest in kWhiz.',
    ...
    'profile.ranking.estimatedMonthlyCost': 'Estimated monthly cost', 'profile.ranking.next': 'View the rest of the ranking', 'profile.ranking.hideNext': 'Hide the rest of the ranking',
    'profile.ranking.lowestCost': 'Lowest cost', 'profile.ranking.costUnavailable': 'Cost unavailable',
    'profile.ranking.details': 'Details', 'profile.ranking.viewDetails': 'View details for {operator} · {formula}',
    ...
    'map.station.atlanteAvailability': 'Check availability on Atlante',
    ...
    'backup.downloaded': 'Profile and preferences saved.',
    ...
    'backup.restoredOne': 'Profile and preferences restored.',
    'backup.restoredMany': 'Profile and preferences restored.',
    ...
    'refresh.buttonLabel': 'Refresh kWhiz',
    ...
    'operators.map': 'Map',
    'operators.details': 'Details',
    'operators.detailsFor': 'View details for {formula}',
